...
$(function() {
    ...
    ToolpathDisplayer.prototype.showToolpathL = function(gcode, wpos, mpos) {
    ...
    ToolpathDisplayer.prototype.reDrawToolL = function(modal, mpos) {
        if (toolSave != null) {
    ...
    root.displayerL = new ToolpathDisplayer();
});
